...
export default function MyClientsPT() {
    const people = [
        ...
        { id: 3, name: 'Martim Silva', age: "29 years", weight: '94kg', height: '185cm', joined: '2 years ago', day:"20", mon:"MAI", year:"2024", time: "18h30", lm: '80%', fm:'20%', cd: " 13th May", img: 'https://img.freepik.com/free-photo/handsome-young-guy-casual-clothing_144627-3016.jpg' },
        ...
        { id: 5, name: 'Joao Mário', age: "30 years", weight: '80kg', height: '180cm', joined: '10 months ago', day:"29", mon:"MAI", year:"2024", time: "18h30", lm: '83%', fm:'17%', cd: " 13th May", img: 'https://img.freepik.com/free-psd/studio-portrait-young-teenage-boy_23-2150162247.jpg' },
    ];
=======
import PageLayoutPT from "../../layouts/PageLayoutPT";
import CardLayout from "../../layouts/CardLayout";
