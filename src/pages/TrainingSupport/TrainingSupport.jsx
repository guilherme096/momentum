        ...
        <PageLayout pageName="Training Support">
            ...
            <div className='rounded-lg  w-full h-48 shadow-md p-6 my-6 flex flex-row'>
                <div className='w-1/2 '>
                   ...
                   <div><p className="text-lg font-bold inline">Repetitions:</p><p className="text-lg inline ml-1">3</p></div>
                   <div><p className="text-lg font-bold inline">Weight:</p><p className="text-lg inline ml-1">3kg</p></div>
                </div>
            ...
            <div className='flex flex-col items-center justify-between'>
                ...
                <div className="flex flex-row justify-between mt-2 max-w-[165px] w-full">
                    <button className="btn btn-md btn-outline btn-circle text-primary p-3"><svg className="max-w-full max-h-full" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path fill="#4556b0" d="M125.7 160H176c17.7 0 32 14.3 32 32s-14.3 32-32 32H48c-17.7 0-32-14.3-32-32V64c0-17.7 14.3-32 32-32s32 14.3 32 32v51.2L97.6 97.6c87.5-87.5 229.3-87.5 316.8 0s87.5 229.3 0 316.8s-229.3 87.5-316.8 0c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0c62.5 62.5 163.8 62.5 226.3 0s62.5-163.8 0-226.3s-163.8-62.5-226.3 0L125.7 160z"/></svg></button>
                    <button className="btn btn-md btn-circle text-primary p-3"><svg className="max-w-full max-h-full" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512"><path fill="#4678ce" d="M48 64C21.5 64 0 85.5 0 112V400c0 26.5 21.5 48 48 48H80c26.5 0 48-21.5 48-48V112c0-26.5-21.5-48-48-48H48zm192 0c-26.5 0-48 21.5-48 48V400c0 26.5 21.5 48 48 48h32c26.5 0 48-21.5 48-48V112c0-26.5-21.5-48-48-48H240z"/></svg></button>
                    <button className="btn btn-md btn-outline btn-circle text-primary p-3"><svg xmlns="http://www.w3.org/2000/svg" className="max-w-full max-h-full" viewBox="0 0 384 512"><path fill="#406bb5" d="M73 39c-14.8-9.1-33.4-9.4-48.5-.9S0 62.6 0 80V432c0 17.4 9.4 33.4 24.5 41.9s33.7 8.1 48.5-.9L361 297c14.3-8.7 23-24.2 23-41s-8.7-32.2-23-41L73 39z"/></svg></button>
                </div>
            </div>
