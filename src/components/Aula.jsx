  ...
  return (
    <>
      ...
      >
        ...
        <ConfirmationModal isOpen={isModalOpen} aula={aula} callback={showSuccess} />
        {success && (
          <div className="rounded px-8 mx-auto fixed bottom-20  w-full left-0 flex flex-col">
            <div role="alert" className="alert alert-success w-full p-4 bg-green-100 text-green-800 text-center flex flex-row">
              <svg xmlns="http://www.w3.org/2000/svg" className="stroke-current shrink-0 h-6 w-6 inline-block mr-3" fill="none" viewBox="0 0 24 24">
